...
export default function Allbloge(params) {
  return (
    <>
      <div className="bg-white p-12">
        <div className="text-5xl mt-6 text-black text-center">
          <h3>بلاگ</h3>
          <h3 className="text-sm text-gray-600 mt-8" dir="rtl">
            مطالعات موردی، گزارش‌ها، پست‌ها و راهنماهایی برای کمک به ارتقا و راه‌اندازی مسیر کسب‌وکار آنلاین شما!
          </h3>
        </div>
        <div className="grid grid-cols-3 px-5 gap-5  mt-10">
